...
- The output CSV will include columns: `statement`, `prediction`, and `confidence (%)`.

**Notes:**
- For CSV files, make sure the column containing your statements is named correctly (default: `"statement"`).
- The function automatically detects the file type and separator.
- Results are saved and can be further analyzed or visualized in the Streamlit app.
...
- **Navigation:** Use the "Next" button to move to the batch prediction page.

<div style="display: flex; gap: 16px; align-items: flex-start;">
  <img src="images/single_statement_lie_detection.png" alt="Streamlit App Single Statement Lie Detection" width="48%">
  <img src="images/explainability_history.png" alt="Streamlit App Explainability and History CSV" width="48%">
</div>
...
<div style="display: flex; gap: 16px; align-items: flex-start;">
  <img src="images/batch_lie_detection.png" alt="Streamlit App Multiple Statement Lie Detection" width="48%">
  <img src="images/batch_prediction.png" alt="Streamlit App Batch Prediction Results" width="48%">
</div>
